...
const Login = () => {
 ...
 console.log(location)
  const notify = () => toast('Check your email to reset password');
...
// }
 ...
 .catch(err=>setErr(err))
    ...
    const handleGoogle=()=>{
      ...
      .then(()=>{
      navigate(location.state ? location.state : '/')
      // navigate(routelocation.state ? location.state : '/')
    ...
    return (
      ...
      <div className="card-body">
        ...
        <form onSubmit={handleLogin} className="fieldset">
          ...
          <input type="email" ref={inputRef} required name='email' className="input" placeholder="Email" />
    ...
    <p className='text-red-600 text-center mt-2'>{err.code}</p>
